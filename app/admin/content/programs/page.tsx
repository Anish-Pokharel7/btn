...
import { Plus, Search, MoreVertical, Edit, Trash2, Eye, Building2, Users, Heart, Sprout, Target } from "lucide-react";
...
export default function ProgramsPage() {
  ...
  return (
    <AdminPage title="Programs Management">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
          <h2 className="text-lg font-semibold text-[#64748B]">Manage core programs and initiatives</h2>
        </div>
        <Link
