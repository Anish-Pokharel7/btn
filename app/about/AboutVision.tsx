...
export default function AboutVision() {
  return (
    <section className="w-full bg-[#F8F9FB] py-14 md:py-20 lg:py-28 px-4 md:px-8 lg:px-12 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-16 xl:gap-20 items-center">
          ...
          <div className="relative group order-1 lg:order-2">
            ...
            <div className="absolute -inset-4 rounded-[2.5rem] bg-gradient-to-br from-blue-100 via-blue-50 to-indigo-100 opacity-60 blur-xl -z-10 group-hover:opacity-80 transition-opacity duration-500" />
            ...
            <div className="absolute -bottom-5 -left-4 sm:-left-6 lg:-left-8 bg-white/95 backdrop-blur-sm rounded-2xl px-5 py-4 shadow-[0_16px_40px_-8px_rgba(0,0,0,0.20)] border border-slate-100 z-10 transition-all duration-300 hover:scale-[1.03] hover:-translate-y-1">
              <p className="text-3xl font-extrabold text-[#012358] leading-none">
                12<span className="text-[#FD6100]">+</span>
              </p>
            ...
            {/* Floating badge card */}
            <div className="absolute -top-4 -right-3 sm:-right-5 lg:-right-6 bg-[#005DCD]/90 backdrop-blur-sm rounded-2xl px-4 py-3.5 shadow-lg z-10 text-white transition-all duration-300 hover:scale-[1.03] hover:-translate-y-1">
              <p className="text-2xl font-extrabold leading-none">
                5K<span className="text-blue-200">+</span>
              </p>
          ...
          <div className="flex flex-col items-start text-left order-2 lg:order-1">
            {/* Section Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-100 text-[#005DCD] text-xs sm:text-sm font-bold tracking-wider uppercase mb-4 border border-[#005DCD]/20">
              <Eye className="w-3.5 h-3.5" />
              <span>Our Vision</span>
            </div>

            {/* Heading */}
            <h2 className="text-3xl sm:text-4xl md:text-[2.6rem] font-extrabold text-[#012358] tracking-tight leading-[1.18] mb-5">
              An Equitable World for{" "}
              <span className="text-[#005DCD]">Every Individual</span>
            </h2>
            ...
            <ul className="flex flex-col gap-3.5 w-full mb-9">
              {visionPoints.map((point, i) => (
                <li key={i} className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-[#FD6100] shrink-0 mt-0.5" />
                  <span className="text-[#012358] text-sm sm:text-base leading-snug">
                    {point}
                  </span>
                </li>
              ))}
            ...
            <Link
              href="/programs"
              className="inline-flex items-center gap-2 text-[#005DCD] hover:text-[#012358] font-semibold text-sm sm:text-base transition-colors group cursor-pointer"
            >
